...
| [Mirror](#mirror) | If set, indicates this stream is a mirror of another stream. See [mirrors](https://docs.nats.io/running-a-nats-service/nats_admin/jetstream_admin/replication#mirrors). | 2.2.0 | No (if defined) |
| [Sources](#sources) | If defined, declares one or more streams this stream will source messages from. See [sources](https://docs.nats.io/running-a-nats-service/nats_admin/jetstream_admin/replication#sources). | 2.2.0 | Yes |
